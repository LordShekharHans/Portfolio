    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="relative z-40 h-[1px] w-full bg-gradient-to-r from-transparent via-purple-400 to-transparent" />
            </div>
            {/* concentric circles */}
...
const Circle = ({ className, children, idx, ...rest }) => {
    return (
        <motion.div
            ...
            className={twMerge(
                "absolute inset-0 left-1/2 top-1/2 h-10 w-10 -translate-x-1/2 -translate-y-1/2 transform rounded-full border border-neutral-200 bg-gradient-to-r from-transparent via-purple-400/5 to-transparent",
                className
            )}
        ></motion.div>
    );
